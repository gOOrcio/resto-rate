...
defaultLogger.debug('This is a DEBUG message with context', {
	query: 'SELECT * FROM users',
	duration: '15ms',
});
defaultLogger.info('This is an INFO message for general information', {
	event: 'server_started',
	port: 3001,
});
defaultLogger.warn('This is a WARN message for potential issues', {
	memory_usage: '85%',
	threshold: '80%',
});
defaultLogger.error('This is an ERROR message for failures', {
	error: 'Database connection failed',
	retries: 3,
});
defaultLogger.fatal('This is a FATAL message for critical failures', {
