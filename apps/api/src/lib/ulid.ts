...
/**
 * Generate a restaurant ID (alias for generateId for clarity)
 */
...
/**
 * Generate a review ID (alias for generateId for clarity)
 */
...
/**
 * Generate a category ID (alias for generateId for clarity)
 */
